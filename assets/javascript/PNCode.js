...
/*
		...
		database.ref("Game").child("question" + index).child("theAnswer").set(randomAnswer);
		database.ref("Game").child("question" + index).child("theAnswers").set(object.incorrect_answers);*/
		game.shallWePlay();
	},
